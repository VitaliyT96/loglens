...
**This is loglens.** Not a dashboard. Not a cloud service. Not another SaaS for $300 a month. Just a blazing fast tool in your terminal that reads your local logs and answers your questions in plain human language.
...
2. 📦 **SDK**: For tools. Install Loglens as a library and embed it into your own tool, deployment script, or CI pipeline. *(e.g., automatically analyze logs from a failed test and add a summary directly to the pull request.)*
